...
window.onload = function () {
    ...
    var width = 310,
        ...
        txt = {font: '14px Georgia', fill: "#fff"},
    ...
    var path = r.path().attr({stroke: color, "stroke-width": 4, "stroke-linejoin": "round"}),
        ...
        leave_timer,
        blanket = r.set();
    label.push(r.text(60, 12, "24 USD").attr(txt));
    label.push(r.text(60, 27, "").attr(txt1).attr({fill: "#ccc"}));
    label.hide();
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot) {
            ...
            rect.hover(function () {
                ...
                label[0].attr({text: data + " UUS-D"}).show().stop().animateWith(frame, anim, {transform: ["t", lx, ly]}, 200 * is_label_visible);
